...
class RMCharacterEpisodeCollectionViewCell: UICollectionViewCell {
    ...
    private func setUpConstraints() {
        NSLayoutConstraint.activate([
            ...
            seasonLabel.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 20),
            ...
            airDateLabel.leftAnchor.constraint(equalTo: contentView.leftAnchor, constant: 20),
